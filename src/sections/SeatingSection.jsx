    ...
    <section id="stoliki" className="py-20 px-4 scroll-mt-20">
      ...
      <div className="max-w-6xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          {/* Tables Grid */}
          <div>
            <h3 className="font-serif text-2xl text-graphite font-medium mb-8">
        ...
        {/* Contact Info */}
        <div className="mt-16 p-8 bg-sage/20 rounded-2xl text-center">
          <h3 className="font-handwriting text-3xl text-cranberry mb-4">
            Pytania?
          </h3>
