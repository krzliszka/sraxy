  ...
  return (
    <div>
      ...
      <section className="py-16 px-4 bg-cream">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-handwriting text-4xl sm:text-5xl text-cranberry text-center mb-16">
            Nasza podróż
          </h2>
                ...
                <div key={index} className="relative">
                  ...
                  <div className={`md:w-1/2 ${item.side === 'right' ? 'md:ml-auto md:pl-12' : 'md:pr-12'}`}>
                    <div className={`bg-sage/20 rounded-2xl p-6 border ${item.highlight ? 'border-cranberry/30 bg-cranberry/5' : 'border-sage/30'}`}>
                      ...
                      <h3 className={`font-handwriting text-2xl ${item.highlight ? 'text-cranberry' : 'text-graphite'} mt-1 mb-2`}>
                        {item.title}
                      </h3>
