    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-16 stripe-pattern overflow-hidden">
        ...
        <div className="text-center z-10 max-w-2xl mx-auto animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-graphite/80 font-serif italic leading-relaxed px-4">
            Mamy zaszczyt i ogromna radosc<br />zaprosic Was na nasz slub!
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h3 className="text-xl font-serif text-graphite font-medium mb-1">Kosciol Wniebowziecia NMP w Jacmierzu</h3>
          <div className="flex items-center justify-center gap-2 text-graphite/60 mb-6">
            <MapPin className="w-4 h-4" />
            <p className="font-serif text-sm">ul. Parkowa 12, Jacmierz</p>
          </div>
          <a href="https://maps.google.com/?q=Kosciol+Wniebowziecia+NMP+Jacmierz" target="_blank" rel="noopener noreferrer"
      ...
      <section className="py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h3 className="text-xl font-serif text-graphite font-medium mb-1">Dwor Wola Sekowa</h3>
          ...
          <p className="font-serif text-graphite/70 italic mb-6">Po ceremonii zapraszamy na wspolne celebrowanie.</p>
          <a href="https://maps.google.com/?q=Dwor+Wola+Sekowa+Nowotaniec" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-cream border-2 border-chocolate/20 rounded-full text-chocolate hover:bg-chocolate/5 transition-colors font-serif text-sm">
            <MapPin className="w-4 h-4" /> Zobacz na mapie
          </a>
          <div className="section-divider mt-12" />
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            <DetailCard icon={<Utensils className="w-6 h-6 text-chocolate" />} title="Dieta">
              Aby kazdy mogl uczestniczyc bez przeszkod, prosimy o informacje o ewentualnych szczegolnych wymaganiach dietetycznych do 01.03.2026.
            </DetailCard>
            <DetailCard icon={<Car className="w-6 h-6 text-chocolate" />} title="Transport">
              Chcemy, zeby kazdy dotarl i wrocil bezpiecznie, wiec dajcie znac, jak planujecie podroz!
            </DetailCard>
            <div className="bg-sage/15 rounded-2xl p-6 sm:p-8 border border-sage/25">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-hand text-2xl sm:text-3xl text-cranberry mb-2">Sroki juz cwierkaja...</h3>
                  <p className="font-serif text-graphite/80 leading-relaxed text-sm">
                    Najpiekniejszym prezentem bedzie Wasza obecnosc - a jesli chcecie dorzucic cos od siebie, zamiast kwiatow, ktore szybko wiedna, ucieszy nas butelka wina albo cos stworzonego Waszymi rekami.
                  </p>
                  <p className="font-serif text-graphite/80 leading-relaxed text-sm mt-2">
                    A jesli myslicie o prezencie, symboliczny wklad w nasza wspolna przyszlosc bedzie dla nas szczegolnie milym gestem.
                  </p>
                </div>
              </div>
            </div>
